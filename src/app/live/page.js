      ...
      <div className="flex flex-col items-center justify-center p-4">
        ...
        <div className="w-full max-w-7xl mx-auto">
          {activeSection === 'live' && (
            <div className="p-4 rounded-lg shadow-md flex flex-col w-7xl items-center">
              {matchesToShow.length === 0 ? (
                ...
                matchesToShow.map((match, index) => (
                  <div key={index} className="mx-auto place-content-center bg-white rounded-[20px] p-[20px] flex w-full max-w-7xl flex-col items-center border mb-4 md:flex-row min-[400px]:flex-row">
                    ...
                    <div className="text-left md:text-left p-4">
                      ...
                      <p className="mt-3 text-[18px] font-bold text-gray-900">Scores: {match.t1s} - {match.t2s}</p>
                      <p className="mt-1 text-lg font-medium text-[#2775f2] animate-pulse">{match.status}</p>
                      
                      {/* <p className="mt-1 text-md font-medium text-gray-900">Date and Time: {new Date(match.dateTimeGMT).toLocaleString()}</p> */}
                      
                      {/* <p className="mt-1 text-sm font-medium text-gray-900">Venue: {match.venue}</p> */}
                      {/* <p className="mt-3 text-lg font-medium text-[#2775f2]">{match.status}</p> */}
                      <p className="mt-2  inline-block rounded-full bg-gray-800 px-3 py-1 text-[12px] font-semibold text-gray-100">Venue: {match.venue}</p>
          ...
          {activeSection === 'upcoming' && (
            <div className="p-4 rounded-lg shadow-md flex flex-col w-7xl items-center">
              {matchData.map((match, index) => (
                <div key={index} className="md:mx-auto md:place-content-center bg-white rounded-[20px] p-[20px] flex w-full max-w-7xl flex-col items-center border mb-4 md:flex-row min-[400px]:flex-row">
                  <div className="flex flex-col justify-center gap-5 mb-4 md:mb-0 md:mr-4">
                    <div className="h-[50px] w-[50px]">
                      <img src={match.t1img} alt={match.t1} className="h-[50px] w-[50px] mx-auto rounded-full object-cover" />
                    </div>
                  ...
                  <div className="flex-grow pl-0 md:pl-4 min-[400px]:pl-4">
                    <div className="text-left">
                      <h1 className="inline-flex text-[#FF5E36] items-center text-[15px] font-bold">
                        {match.t1} vs {match.t2}
                      </h1>
                      {/* <p className="mt-1 text-sm font-medium text-gray-800">Scores: {match.t1s} - {match.t2s}</p> */}
                      {/* <p className="mt-1 text-sm font-medium text-gray-800">Venue: {match.venue}</p> */}
                      <p className="mt-1 text-md font-medium text-gray-800">Date and Time: {new Date(match.dateTimeGMT).toLocaleString()}</p>
                      <p className="mt-1 text-md font-medium text-gray-800">{match.status}</p>
                      <p className="mt-1  inline-block rounded-full bg-gray-800 px-3 py-1 text-[12px] font-semibold text-gray-100">Venue: {match.venue}</p>
                ...
                <div key={index} className="mx-auto place-content-center bg-white rounded-[20px] p-[20px] flex w-full max-w-7xl flex-col items-center border mb-4 md:flex-row min-[400px]:flex-row">
                  ...
                  <div>
                    <div className="text-left md:text-left p-4">
                      ...
                      <p className="mt-1 text-lg font-bold text-gray-800">Scores: {match.score[0]?.r}-{match.score[0]?.w} ({match.score[0]?.o}) - {match.score[1]?.r}-{match.score[1]?.w} ({match.score[1]?.o})</p>
                      <p className="mt-1 text-sm font-bold text-[#2775f2] animate-pulse">{match.status}</p>
                      <p className="mt-1 text-sm font-medium text-gray-800">Date and Time: {new Date(match.dateTimeGMT).toLocaleString()}</p>
                      <p className="mt-2  inline-block rounded-full bg-gray-800 px-3 py-1 text-[12px] font-semibold text-gray-100">Venue: {match.venue}</p>
                    </div>
                  </div>
                  {/* <div className="md:block hidden h-full w-full md:h-[50px] md:w-[50px]">
